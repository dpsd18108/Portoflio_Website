    ...
    <div class="container">
      <div class="row mb-5 align-items-end">
        <div class="col-md-6" data-aos="fade-up">
          ...
          <p class="mb-0"> Ήμαστε δύο φίλοι-συνεργάτες που γνωριστήκαμε τις πρώτες μέρες της φοιτητικής μας ζωής στο Τμήμα Μηχανικών Σχεδίασης Προϊόντων & Συστημάτων. 
          Από τότε συνεχίζουμε ως σήμερα έχοντας και οι δύο ένα κοινό όραμα αλλα ο καθένας μας διαφορετικές δεξιότητες, γνώσεις και βιώματα που μας επιτρέπουν
           να συνθέτουμε ένα άρτιο και ολοκληρωμένο αποτέλεσμα  σε πολλαπλά επίπεδα. </p>
        </div>
      ...
      <div class="row">
        ...
        <div class="col-md-7 mb-5 mb-md-0" data-aos="fade-up">
          <p><img src="assets/img/abaoutus.jpg" alt="Image" class="img-fluid"></p>
          ...
          <p><a href="#" class="readmore">Download our CV</a></p>
        </div>
